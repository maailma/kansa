...
const PostDeadlineContents = () => (
  <Card>
    <CardText className="vote-intro" style={{ padding: '16px 32px' }}>
      <h3>
        Thank you for having participated in the 2017 Hugo Awards and the John
        W. Campbell Award!
      </h3>
      ...
      <p>
        ...
        Convention (“Worldcon”). The finalists for the 2017 Hugo Awards and John
      ...
      <p>
        ...
        August 2017, at Worldcon 75, the 75th World Science Fiction Convention,

...
const NavAvatars = ({ currentMember, otherMembers }) => (
  <div style={{ display: 'flex', padding: '72px 16px 16px' }}>
    <div style={{ flexGrow: otherMembers ? 1 : 0 }}>
      {currentMember && (
        <MemberAvatar member={currentMember} single={!otherMembers} size={56} />
      )}
    </div>
    {otherMembers
...
const NavHead = ({ currentMember, handleNav, otherMembers }) => (
  <div
    onClick={() => handleNav('/')}
    style={{
  ...
  >
    <NavAvatars currentMember={currentMember} otherMembers={otherMembers} />
    {currentMember &&
      otherMembers && (
        <div
          style={{
